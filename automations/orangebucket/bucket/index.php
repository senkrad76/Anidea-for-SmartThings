...
//
// Bucket (index.php) - (C) Graham Johnson 2020
// ============================================
// Version: 20.06.13.01
//
...
function afww_config_initialize()
{
...
function afww_config_subscription( $config )
{
...
function afww_config_event( $eventpost )
{
...
afww_main( 'https://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'] );
?>
