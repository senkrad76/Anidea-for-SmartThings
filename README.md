...
The repository layout is compatible with the IDE for [Groovy Device Handlers](devicetypes/orangebucket) and SmartApps. Other scripts and things sit under the [anidea-st](anidea-st) folder.
